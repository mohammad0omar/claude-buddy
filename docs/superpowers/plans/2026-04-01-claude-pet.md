# claude_buddy Implementation Plan
...
console.log(`claude_buddy v0.1.0`);
...
Run: `cd /Users/mohammad/Desktop/claude_buddy && npm install`
...
git commit -m "feat: pet config manager (~/.claude_buddy.json)"
```
...
function printHelp() {
  console.log(`
${chalk.bold('claude_buddy')} v${VERSION}
...
Run: `npm link && npx claude_buddy --version`
Expected: `0.1.0`
